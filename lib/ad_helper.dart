...
class AdHelper {
  static String get allScreenFooterAdUnit {
  ...
  static String get afterCarouselTitleAdUnit {
    if (Platform.isAndroid) {
  ...
  static String get transitionToMindmapAdUnit {
    if (Platform.isAndroid) {
  ...
  static String get backupNativeAdUnit {
    if (Platform.isAndroid) {
      return "ca-app-pub-8253303708714765/9271205570";
    } else if (Platform.isIOS) {
      return "ca-app-pub-8253303708714765/8649492691";
    } else {
      throw UnsupportedError("Unsupported platform");
    }
  }
